({ 
    ...
    showTMTitle: function (cmp, event, helper){
        ...
        helper.getDays(cmp, event, helper); 
                ...
                showTMStartDate: function (cmp, event, helper){
                    const showTMStartDate = !cmp.get('v.showTMStartDate')
                    cmp.set('v.showTMStartDate', showTMStartDate);
                    helper.getDays(cmp, event, helper);
                },
